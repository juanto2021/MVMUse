...
// $Id: EvalContext.java 5494 2015-02-05 12:59:25Z lhamann $
...
public class EvalContextMVM {
     ...
     */
    public EvalContextMVM(MSystemState preState,
     ...
     */
	public EvalContextMVM(MSystemState preState, MSystemState postState, VarBindings globalBindings, EvalContextMVM src) {
		fPreState = preState;
		fPostState = postState;
		fVarBindings = new VarBindings(globalBindings);
