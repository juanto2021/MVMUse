...
// $Id: ThreadedEvaluator.java 2626 2011-10-19 09:19:51Z lhamann $
...
class ThreadedEvaluatorMVM {
    ...
    static class Controller extends Thread {
        ...
        private ArrayList<ExpressionMVM> fExprList;
        ...
        Controller(int numWorkers, Queue resultQueue, 
                   ArrayList<ExpressionMVM> exprList, MSystemState systemState) {
    ...
    static class Worker extends Thread {
        ...
        public void run() {
            ...
            while ((job = fController.getNextJob()) != null ) {
                ...
                EvaluatorMVM evaluator = new EvaluatorMVM();
