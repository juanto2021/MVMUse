...
// $Id: Expression.java 5494 2015-02-05 12:59:25Z lhamann $
 ...
 */
public class ExpressionMVM implements BufferedToString {
    ...
    protected ExpressionMVM(Type t) {
        fType = t;
    }
    
    public ExpressionMVM() {
		super();
		// TODO Auto-generated constructor stub
		Type fType=null;
		SrcPos fSourcePosition = new SrcPos("", 0, 0) ;
		this.fSourcePosition = fSourcePosition;
		
		this.fType = fType;
		this.fIsPre = false;
		this.preStateRequired = false;
	}

	public ExpressionMVM(SrcPos fSourcePosition, Type fType, boolean fIsPre, Boolean preStateRequired) {
		super();
		this.fSourcePosition = fSourcePosition;
		this.fType = fType;
		this.fIsPre = fIsPre;
		this.preStateRequired = preStateRequired;
	}

	public static ExpressionMVM convertExpToExpMVM(Expression expVar) {
    	ExpressionMVM res = new ExpressionMVM();
    	res.fType=expVar.type();
    	res.fIsPre=expVar.isPre();
    	res.fSourcePosition=expVar.getSourcePosition();
    	res.preStateRequired = expVar.requiresPreState();
     ...
     */
    public abstract Value eval(EvalContextMVM ctx);
